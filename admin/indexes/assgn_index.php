...
<head>
    <style>
        ...
        #responseMessageAssgn {
           height: 20px; 
        }
    </style>
</head>
<body>
<h2 id="responseMessageAssgn">&nbsp;</h2>

<div id="updateTableContainerAssgn">
<?php
include("../db.php");
$sql = "SELECT i.*, 
           cl.date_of_class,
...
<button onclick="showFormAssgn('create_mode_assgn', null)">Create Task</button>
