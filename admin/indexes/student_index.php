...
<button style="border: 1px solid #ccc; border-radius: 5px; background-color: #007bff; color: #fff; cursor: pointer;" type="button" onclick="selectFile();">Import Students</button>
...
if (!empty($searchName)) {
    $whereClause .= " AND s.student_username LIKE '$searchName%'";
}
